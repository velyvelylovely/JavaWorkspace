...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        // 지금까지 배운 변수는 처음에 값을 초기화하고 나서 필요하면 뒤에서 변수의 값을 바꿀 수 있었는데,
        // 상수는 한 번 정의되고 나면 값을 절대 바꿀 수 없다.
        // 절대 변하지 않는 상수는 변수명을 대문자로 적는다.
        final String CODE = "KR"; // final 이라는 예약어를 붙이면 상수가 된다.
        // CODE = "US"; 상수는 한 번 정의되고 나면 절대 바꿀 수 없다.
    }
}
